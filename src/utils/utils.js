...
const inBetweenProbability = 0.1;
...
export const getRandomPenalties = () => {
  ...
  if (typeof penalties !== "object")
    penalties = penaltyProbabilities[penaltyProbabilities.length - 1];
...
export const getRandomSkaterPosition = () => {
  ...
  if (typeof position !== "object")
    position = positionProbabilities[positionProbabilities.length - 1];
