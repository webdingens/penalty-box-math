  ...
  return (
    <div className={styles.help}>
      ...
      >
        ...
        <h2>Tip 3:</h2>
        <p>
          With two penalties it might be easier to add the full minute first,
          then subtract 10 seconds.
        </p>
        ...
        <table>
          <tbody>
            ...
            {!hideLastSecondsDigit
              ? [...Array(61).keys()].map((key) => (
                  <tr key={key}>
              ...
              : [...Array(7).keys()].map((key) => (
                  <tr key={key}>
                    <td>
                      {getTableDisplay(key * 10, 0, hideLastSecondsDigit)}
                    </td>
                    <td>
                      {getTableDisplay(key * 10, 20, hideLastSecondsDigit)}
                    </td>
                    <td>
                      {getTableDisplay(key * 10, 30, hideLastSecondsDigit)}
                    </td>
                    <td>
                      {getTableDisplay(key * 10, 50, hideLastSecondsDigit)}
                    </td>
                    <td>
                      {getTableDisplay(key * 10, 60, hideLastSecondsDigit)}
                    </td>
                  </tr>
                ))}
          </tbody>
